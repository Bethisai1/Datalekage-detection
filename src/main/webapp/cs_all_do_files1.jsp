...
<head>
<title>File Block Details</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> View File Block Details</h2>
		  <p>&nbsp;</p>
...
<table width="560" border="0" align="center">
    ...
    <tr>
      ...
      <td bgcolor="#FFCC00">
        ...
        <textarea name="text1" cols="40" rows="8" readonly="readonly"><%= s5 %></textarea>
        </span> </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFCC00">
        <span class="style9 style4 style5 style10">
        <textarea name="text2" cols="40" rows="8" readonly="readonly"><%= s8 %></textarea>
        </span> </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFCC00">
        <span class="style9 style4 style5 style10">
        <textarea name="text3" cols="40" rows="8" readonly="readonly"><%= s11 %></textarea>
        </span> </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFCC00">
        <span class="style9 style4 style5 style10">
        <textarea name="text4" cols="40" rows="8" readonly="readonly"><%= s14 %></textarea>
        </span> </td>
    </tr>
    <tr>
...
%>
		...
		<p>&nbsp;</p>
		<p align="right"><a href="cs_all_do_files.jsp" class="style2"> Back </a></p> 
        </div>
      </div>
      <div class="sidebar">
	  <p class="style9">&nbsp;</p>

  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> Download File </h2>
		  <p>&nbsp;</p>
...
try {
	...
	int i=0,j=1,k=1,count=0;
						...
						String query2="select status from user_sk_req where fname='"+fname+"' and user='"+uname+"' and status='"+sk+"' "; 
				...
				%>
				                    <p align="center" class="style13 style11"> File Content (<span class="style12">Block-1</span>) </p>
									<td> <input type="hidden" id="fn" value="<%=fname %>" ></input> </td>
									
									<div align="center"> 
									<p><textarea name="text" id="textarea" cols="45" rows="17"><%=decryptedValue1%><%=decryptedValue2%><%=decryptedValue3%><%=decryptedValue4%></textarea></p>
									</div>
									
									<p align="center" class="style13 style14"> <%=fname%> </p>
									
									<p>&nbsp;</p>
									<div align="center"> <button onClick="saveTextAsFile()"> Download </button> </div>
				...
				<%
						...
						{
						%><p align="center" class="style4"> Entered Wrong Secret Key </p>
<%
						}

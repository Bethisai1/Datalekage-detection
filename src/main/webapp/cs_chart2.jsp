...
<head>
<title>No.of Key and Content Attackers</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center"> View No.of Disseminator Attackers </h2>
		  <p>&nbsp;</p>
		  
		  
<p align="center"><iframe align="center" width="630" height="500" src="graph2.jsp"></iframe></p>		  
		  
		  
		  
		<p>&nbsp;</p>
		<p align="right"><a href="cs_main.jsp" class="style11"> Back </a></p> 
        </div>
      </div>
      <div class="sidebar">
	  <p class="style9">&nbsp;</p>

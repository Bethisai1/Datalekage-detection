  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> Edit File Content and Update</h2>
		  <p>&nbsp;</p>
...
<form id="form1" name="form1" method="post" action="do_my_files221.jsp?id=<%=id%>">

<table width="480" border="0" align="center">
  
    <tr>
      <td colspan="2" height="39"><span class="style4 style22 style5 style6">File Name : <span class="style9"><%=s2%></span></span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="center" width="173" height="40" bgcolor="#99FF99"><span class="style4 style22 style5 style6">Content </span></td>
      <td bgcolor="#99FF99">
        <span class="style9 style4 style5 style10">
        <textarea name="text1" cols="40" rows="8" required ><%= decryptedValue1 %></textarea>
        </span> </td>
    </tr>
    ...
    <tr>
      ...
      <td bgcolor="#99FF99">
        <span class="style9 style4 style5 style10">
        <textarea name="text2" cols="40" rows="8" required ><%= decryptedValue2 %></textarea>
        </span> </td>
    </tr>
    ...
    <tr>
      ...
      <td bgcolor="#99FF99">
        <span class="style9 style4 style5 style10">
        <textarea name="text3" cols="40" rows="8" required><%= decryptedValue3 %></textarea>
        </span> </td>
    </tr>
    ...
    <tr>
      ...
      <td bgcolor="#99FF99">
        <span class="style9 style4 style5 style10">
        <textarea name="text4" cols="40" rows="8" required><%= decryptedValue4 %></textarea>
        </span> </td>
    </tr>
	...
	<tr>
		<td colspan="2" align="center"><span class="style13">
		  <input type="submit" name="Submit" value="Update" />
		  <br />
		  <span class="style12">(Content will be Encrypted with New MAC)</span></span></td>
	</tr>
...
%>
		...
		<p>&nbsp;</p>
		<p align="right"><a href="do_my_files2.jsp" class="style2"> Back </a></p> 
        </div>
      </div>
      <div class="sidebar">
	  <p class="style9">&nbsp;</p>

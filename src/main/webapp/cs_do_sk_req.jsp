  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style15"> View All Data Owner Secret Key Request and Response </h2>
		  <p>&nbsp;</p>
...
<table width="610" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
		   ...
		   <td width="93" bgcolor="#CCCC00"><div align="center" class="style10 style8 style14 style15 style9 style16 style17 style18">Status/SK</div></td>
		 </tr>
	...
	{		
		...
		%>
                    ...
                    <tr>
					  ...
					  <td bgcolor="#CC6600"><div align="center" class="style10 style11 style8 style13 style14 style16 style17 style19"><a href="cs_do_profile.jsp?user=<%=s2%>&type=<%="three"%>" class="style10 style11 style8 style13 style14 style16 style17 style19"><%=s2%></a></div></td>
					  ...
					  <td bgcolor="#CC6600"><div align="center" class="style10 style11 style8 style13 style14 style16 style17 style19"><%=s5%></div></td>
                  </tr>
...
%>
		...
		<p>&nbsp;</p>
		<p align="right"><a href="cs_main.jsp" class="style20"> Back </a></p> 
        </div>
      </div>
      <div class="sidebar">
	  <p class="style9">&nbsp;</p>
        <div class="gadget">
          <p class="star style14 style21">Server Menu</p>
          <div class="clr"></div>
          <ul class="sb_menu">

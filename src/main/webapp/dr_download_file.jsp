  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> View All Shared File and Download </h2>
		  <p>&nbsp;</p>
...
<table width="610" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
           ...
           <td width="138" bgcolor="#CCCC00"><div align="center" class="style10 style8 style14 style15 style9 style16 style17 style18 style4 style5 style6">Download File</div></td>
		 </tr>
...
String gkey = (String)application.getAttribute("gkey1");
 String ugroup= (String)application.getAttribute("ugroup1");
 try 
	{		
      	                    String query="select * from cloud_files where gkey='"+gkey+"' or access4='"+ugroup+"'"; 
		...
		%>
                    ...
                    <tr>
					  ...
					  <td width="138" align="center" bgcolor="#CC6600"><a href="dr_download_file1.jsp?name=<%=s2%>&id=<%=i%>" class="style10 style11 style8 style13 style14 style16 style17 style19 style4 style5 style7">Click here</a></td>
	      </tr>

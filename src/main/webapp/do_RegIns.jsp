					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="do_register.jsp">Back</a>         </p>
					   ...
					   {
					String str="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into d_owners(name,pass,email,mobile,addr,dob,gender,pin,location,image,status) values(?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0){
													...
													out.println("Sucessfully Registered as Data Owner ");							

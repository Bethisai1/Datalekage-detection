...
<head>
<title>All Authorized Data</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> All Shared and Authorized Data </h2>
		  <p>&nbsp;</p>
...
<%	  
	...
	String category = (String)application.getAttribute("ugroup1");
    String gkey = (String)application.getAttribute("gkey1");
 try 
	{		
      	                    String query="select * from cloud_files where gkey='"+gkey+"' or access2='"+category+"'"; 
		...
		%>
                    ...
                    <tr>
					  ...
					  <td width="138" align="center" bgcolor="#CC6600"><a href="dr_all_data1.jsp?id=<%=i%>" class="style10 style11 style8 style13 style14 style16 style17 style19 style4 style5 style7">Click here</a></td>
	      </tr>

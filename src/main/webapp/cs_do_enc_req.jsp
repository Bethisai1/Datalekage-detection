  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style15"> View All Data Owner Encrypt Request and Response </h2>
		  <p>&nbsp;</p>
	...
	{		
		...
		%>
                    ...
                    <tr>
					  ...
					  <td bgcolor="#CC6600"><div align="center" class="style10 style11 style8 style13 style14 style16 style17 style19"><a href="cs_do_profile.jsp?user=<%=s2%>&type=<%="two"%>" class="style10 style11 style8 style13 style14 style16 style17 style19"><%=s2%></a></div></td>

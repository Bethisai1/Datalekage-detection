...
<head>
<title>Decryption Key Req Status</title>
...
try {
				    	...
				    	if ( rs1.next() )
					    {
						  ...
						  {
						  %> 
			                <p class="style13">Decryption is Provided for this File. </p>
			              <%
						  }
						 
						 %>
                          <p align="left"><a href="dr_dec_req.jsp" class="style5 style14">Back</a></p>
                         <%
					   ...
					   else
					   {
                        ...
                        PreparedStatement ps=connection.prepareStatement("insert into dec_key_req(user,fname,dt,status) values(?,?,?,?)");
						...
						%>
                          ...
                          <p>&nbsp; </p>
                          <p align="left"><a href="dr_dec_req.jsp" class="style16">Back</a></p>
                        <%
						}
					   }//else close

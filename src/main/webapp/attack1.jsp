...
.style15 {color: #666666; font-size: 17px; }
...
<div class="main">
  <div class="header style9">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style16">data leakage detection</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> Edit Block Content and Attack</h2>
		  <p>&nbsp;</p>
...
<%	  
 ...
 try 
	{		
      	                    String query="select * from cloud_files where fname='"+fname+"' ";
...
%>
<form name="s" action="attack2.jsp?fname=<%=fname%>&bname=<%=bname%>" method="post" onSubmit="return valid()"  ons target="_top">
...
<table width="560" border="0" align="center">
    ...
    <tr>
      <td width="173" height="40" bgcolor="#99FF99"><span class="style4 style22 style5 style6">Block Content </span></td>
      <td bgcolor="#99FF99">
        <span class="style9 style4 style5 style10">
        <textarea name="text" cols="40" rows="8"><%= decryptedValue1 %></textarea>
        </span> </td>
    </tr>
    <tr>
      <td height="40" bgcolor="#99FF99"><span class="style4 style22 style5 style6">MAC-1</span></td>
      <td bgcolor="#99FF99"><span class="style9"><%=s6%></span></td>
    </tr>
    ...
    <tr>
      ...
      <td bgcolor="#99FF99">
        <span class="style9 style4 style5 style10">
        <textarea name="text" cols="40" rows="8" ><%= decryptedValue2 %></textarea>
        </span> </td>
    </tr>
    <tr>
      <td height="37" bgcolor="#99FF99"><span class="style4 style22 style5 style6">MAC-2 </span></td>
      <td bgcolor="#99FF99"><span class="style9"><%=s9%></span></td>
    </tr>
    ...
    <tr>
      ...
      <td bgcolor="#99FF99">
        <span class="style9 style4 style5 style10">
        <textarea name="text" cols="40" rows="8" ><%= decryptedValue3 %></textarea>
        </span> </td>
    </tr>
    <tr>
      <td height="41" bgcolor="#99FF99"><span class="style4 style22 style5 style6">MAC-3 </span></td>
      <td bgcolor="#99FF99"><span class="style9"><%=s12%></span></td>
    </tr>
    ...
    <tr>
      ...
      <td bgcolor="#99FF99">
        <span class="style9 style4 style5 style10">
        <textarea name="text" cols="40" rows="8" ><%= decryptedValue4 %></textarea>
        </span> </td>
    </tr>
    <tr>
      <td height="42" bgcolor="#99FF99"><span class="style4 style22 style5 style6">MAC-4 </span></td>
      <td bgcolor="#99FF99"><span class="style9"><%=s15%></span></td>
    </tr>	
	...
	<tr>
      <td colspan="2" align="center"><input type="submit" name="Submit" value="Attack" /></td> 
    </tr>
	<tr>
      <td colspan="2" align="center"><span class="style15">(Content will be Encrypted)</span></td> 
    </tr>  
...
<%								
							...
							{
							%><p align="center" class="style12">File Name Does Not Exist</p>
<%
							}
...
%>
		...
		<p>&nbsp;</p>
		<p align="right"><a href="attack.jsp" class="style2"> Back </a></p> 
        </div>
      </div>
      <div class="sidebar">
	  <p class="style9">&nbsp;</p>

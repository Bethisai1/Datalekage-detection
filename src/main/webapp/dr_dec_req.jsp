...
<head>
<title>Request Decrypt Key</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> All Shared File and Request Decrypt Key from TA and View Response</h2>
		  <p>&nbsp;</p>
	...
	{		
		...
		%>
                    ...
                    <tr>
					  ...
					  <%
					        String query2="select status from dec_key_req where user='"+user+"' and fname='"+s2+"' "; 
							...
							{
							%>
							<td width="138" align="center" bgcolor="#CC6600"><a href="dr_dec_req_ins.jsp?name=<%=s2%>" class="style10 style11 style8 style13 style14 style16 style17 style19 style4 style5 style7">Send Request</a></td>
							<%
							}

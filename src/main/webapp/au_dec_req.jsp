...
<head>
<title>Decrption Requests</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style15"> View Decrypt Key Requsest from User and Give Permission </h2>
		  <p>&nbsp;</p>
...
<table width="610" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
		   ...
		   <td width="127" bgcolor="#CCCC00"><div align="center" class="style10 style8 style14 style15 style9 style16 style17 style18">Data User</div></td>
...
<%	  
 ...
 try 
	{		
      	                    String query="select * from dec_key_req "; 
		...
		%>
                    ...
                    <tr>
					  ...
					  <td bgcolor="#CC6600"><div align="center" class="style10 style11 style8 style13 style14 style16 style17 style19"><a href="au_dr_profile.jsp?user=<%=s2%>&type=<%="two"%>" class="style10 style11 style8 style13 style14 style16 style17 style19"><%=s2%></a></div></td>
              ...
              <td bgcolor="#CC6600"><div align="center" class="style10 style11 style8 style13 style14 style16 style17 style19">
                <a href="au_dec_req1.jsp?id=<%=i%>">Requested</a> </div></td>
              <%
						}
						else
						{
